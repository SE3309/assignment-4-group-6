    ...
    const handleLogin = async (e) =>
    {
        ...
        try
        {
            ...
            if (role === "user")
            {
                ...
                const response = await fetch(`http://localhost:3000/api/login?UserID=${username}&Password=${password}`);
            ...
            } else if (role === "artist")
            {
                ...
                const response = await fetch(`http://localhost:3000/api/artist-login?email=${username}&password=${password}`);
                ...
                if (response.ok)
                {
                    ...
                    // Store the token and artist info
            ...
            <div style={styles.content}>
                ...
                <div style={styles.loginBox}>
                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <label style={styles.formLabel}>LOGIN AS</label>
                        ...
                        <input
                            ...
                            placeholder={role === "artist" ? "Enter your email" : "Enter your username"}
